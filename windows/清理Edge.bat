...
sc stop edgeupdate >NUL 2>NUL&sc delete edgeupdate >NUL 2>NUL
sc stop edgeupdatem >NUL 2>NUL&sc delete edgeupdatem >NUL 2>NUL
...
IF "%ERRORLEVEL%"=="1" (
  IF EXIST "Data" (
    FOR /F "delims=*" %%a IN ('dir /a/b *.*^|findstr /v /i "Data$"') DO (
